...
if __name__ == "__main__":
    ...
    ChatGPTApp = AutomateUserDataFolder / f'ChatGPTApp_{computer_marker}'
    logger.debug(f'{ChatGPTApp=}')
    # upload_logo = ChatGPTApp / '回形针上传文件.png'
    upload_logo = ChatGPTApp / '加号上传文件.png'
    ...
    headphone_logo = ChatGPTApp / '耳罩.png'
    four_bars_logo = ChatGPTApp / '四竖.png'
    ...
    ChatGPT4omini_logo = ChatGPTApp / 'ChatGPT 4o mini>.png'

    upload_logo = ChatGPTApp / '十字.png'
    up_arrow_logo = ChatGPTApp / '黑色上箭头.png'
    stop_logo = ChatGPTApp / '黑色停止.png'
    microphone_logo = ChatGPTApp / '空心话筒.png'
    headphone_logo = ChatGPTApp / '实心耳机.png'

    upload_logo = ChatGPTApp / '十字新.png'
    # up_arrow_logo = ChatGPTApp / '黑色上箭头新.png'
    up_arrow_logo = ChatGPTApp / 'black_up_arrow_new.png'
    # stop_logo = ChatGPTApp / '黑色停止新.png'
    stop_logo = ChatGPTApp / 'black_stop_new.png'
    microphone_logo = ChatGPTApp / '话筒新.png'
    headphone_logo = ChatGPTApp / '耳机新.png'

    upload_logo = ChatGPTApp / '十字new.png'
    headphone_logo = ChatGPTApp / '黑色四竖.png'

    upload_logo = ChatGPTApp / '十字新new.png'
    microphone_logo = ChatGPTApp / '话筒新new.png'

    # headphone_logo = ChatGPTApp / '语音模式.png'

    headphone_logo = ChatGPTApp / '黑色四竖New.png'
    # headphone_logo = ChatGPTApp / '黑色背景四竖.png'
    headphone_logo = ChatGPTApp / 'black_bg_4bars.png'

    # Claude
    paper_clip_logo = ChatGPTApp / '回形针.png'
    trans_stop_logo = ChatGPTApp / '半透明停止.png'
    brown_upper_logo = ChatGPTApp / '棕色上箭头.png'
